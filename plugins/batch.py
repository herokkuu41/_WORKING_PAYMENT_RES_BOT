        ...
        for idx, slot in enumerate(slots, start=1):
            ...
            for j in range(slot['count']):
                ...
                try:
                    ...
                    if msg:
                        res = await process_msg(UB.get(uid), UC.get(uid), msg, str(message.chat.id), slot['lt'], uid, slot['cid'])
            ...
            for j in range(n):
                ...
                try:
                    ...
                    if msg:
                        ...
                        if isinstance(res, str) and ('Done' in res or 'Copied' in res or 'Sent' in res):
                            success += 1
                    else:
                        try:
